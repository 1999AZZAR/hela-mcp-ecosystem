...
> **Live Production References Generated by HeLa Phenotype (`the-designer`):**
> * [Ellis UI Archive / The Collection](https://demo-designer.glassgallery.my.id/) — 24 bespoke anti-slop design systems (*Game Boy, Dossier, Nutrition Label, Gothic Tome*).
> * [Aluluf Kitchen — Daily Hardwood Fire Menu & Polling](http://example.very3d.co.id/) — Jakarta culinary web app with audience menu voting, suggestion poll modal, past days archive, and bilingual (ID/EN) support.
